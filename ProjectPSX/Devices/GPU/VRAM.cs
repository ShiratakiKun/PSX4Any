...
namespace ProjectPSX
{
    ...
    public class VRAM
    {
        ...
        public void SetPixel(int x, int y, int color)
        {
            ...
            ref int r0 = ref MemoryMarshalExt.GetArrayDataReference(Bits);
            Unsafe.Add(ref r0, (IntPtr)index) = color;
        }
        ...
        public ref int GetPixelRGB888(int x, int y)
        {
            ...
            ref int r0 = ref MemoryMarshalExt.GetArrayDataReference(Bits);
            ref int ri = ref Unsafe.Add(ref r0, (IntPtr)index);
        ...
        public ushort GetPixelBGR555(int x, int y)
        {
            ...
            ref int r0 = ref MemoryMarshalExt.GetArrayDataReference(Bits);
            ref int color = ref Unsafe.Add(ref r0, (IntPtr)index);
