...
namespace ProjectPSX
{
    ...
    {  //MIPS R3000A-compatible 32-bit RISC CPU MIPS R3051 with 5 KB L1 cache, running at 33.8688 MHz // 33868800
        ...
        private delegate void opcodeMainTableDelegate(CPU cpu);
        private delegate void opcodeSpecialTableDelegate(CPU cpu);

        private static opcodeMainTableDelegate[] opcodeMainTable = new opcodeMainTableDelegate[]
        {
        ...
        private static opcodeSpecialTableDelegate[] opcodeSpecialTable = new opcodeSpecialTableDelegate[]
        {
        ...
        private void MemAccess()
        {
            ...
            { //if loadDelay on same reg it is lost/overwritten (amidog tests)
                ref uint r0 = ref MemoryMarshalExt.GetArrayDataReference(GPR);
                Unsafe.Add(ref r0, (IntPtr)memoryLoad.register) = memoryLoad.value;
            }
        ...
        {
            ref uint r0 = ref MemoryMarshalExt.GetArrayDataReference(GPR);
            Unsafe.Add(ref r0, (IntPtr)writeBack.register) = writeBack.value;
