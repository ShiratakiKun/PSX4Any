...
namespace ProjectPSX
{
    ...
    { //PSX MIPS Coprocessor 02 - Geometry Transformation Engine
        ...
        private void RTPS(int r, bool setMac0)
        {
            ...
            IR[3] = (short)MathHelper.Clamp(MAC3, lm ? 0 : -0x8000, 0x7FFF);
        ...
        internal uint loadData(uint fs)
        {
            ...
            switch (fs)
            {
                ...
                case 23: value = RES1; break;
                case 24: value = (uint)MAC0; break;
                case 25: value = (uint)MAC1; break;
                case 26: value = (uint)MAC2; break;
                case 27: value = (uint)MAC3; break;
                case 28: value = IRGB = (ushort)(saturateRGB(IR[3] / 0x80) << 10 | saturateRGB(IR[2] / 0x80) << 5 | saturateRGB(IR[1] / 0x80)); break;
                case 29: value = IRGB = (ushort)(saturateRGB(IR[3] / 0x80) << 10 | saturateRGB(IR[2] / 0x80) << 5 | saturateRGB(IR[1] / 0x80)); break;
        ...
        public uint loadControl(uint fs)
        {
            ...
            switch (fs)
            {
                ...
                case 26: value = (uint)(short)H; break;
                case 27: value = (uint)DQA; break;
                case 28: value = (uint)DQB; break;
                case 29: value = (uint)ZSF3; break;
                case 30: value = (uint)ZSF4; break;
